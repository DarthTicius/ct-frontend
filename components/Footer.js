...
import { ChevronDownIcon } from '@heroicons/react/solid/index';
			...
			<div className="mx-auto max-w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
				<div className="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
					<div className="grid grid-cols-2 gap-8 xl:col-span-4">
						<div className="md:grid md:grid-cols-2 md:gap-8">
							<div>
								<h3 className="text-base font-medium text-white">Cars</h3>
							...
							<div className="mt-12 md:mt-0">
								<h3 className="text-base font-medium text-white">Motorcycles</h3>
								<ul className="mt-4 space-y-4">
									{navigation.motorcycles.map((item) => (
										<li key={item.name}>
											<a href={item.href} className="text-base text-gray-300 hover:text-white">
												{item.name}
											</a>
				...
				<div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
					<p className="mt-8 text-base text-gray-400 md:order-1 md:mt-0">
						&copy; {new Date().getFullYear()} CT Trader, Inc. All rights reserved.
					</p>
				</div>
			</div>
		</footer>
