					...
					<div className="max-w-xl mx-auto overflow-hidden rounded-lg shadow-lg lg:max-w-none lg:flex">
						<div className="flex-1 px-6 py-8 bg-white lg:p-12">
							<h3 className="text-2xl font-extrabold text-gray-900 sm:text-3xl">
								{yearOfProduction} | {car.specification}
							</h3>
							<div className="flex justify-between flex-col lg:flex-row">
								<p className="mt-6 text-base text-gray-500">City: {location.city}</p>
								<p className="mt-6 text-base text-gray-500">Country: {location.countryCode}</p>
							</div>
							<div className="mt-8">
								...
								<ul className="mt-8 space-y-5 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:gap-y-5">
									<li className="flex items-start lg:col-span-1">
										...
										<p className="ml-3 text-sm text-gray-700">Manufacturer: {manufacturerCode}</p>
									</li>
									<li className="flex items-start lg:col-span-1">
										<div className="flex-shrink-0">
											<svg
										...
										<p className="ml-3 text-sm text-gray-700">
											Body: {car.body} / {car.bodyDetailed}
										</p>
									</li>
									<li className="flex items-start lg:col-span-1">
										<div className="flex-shrink-0">
										...
										<p className="ml-3 text-sm text-gray-700">Horsepower: {horsepower} </p>
									</li>
									<li className="flex items-start lg:col-span-1">
										<div className="flex-shrink-0">
											<svg
										...
										<p className="ml-3 text-sm text-gray-700">CC: {cubicCapacity}</p>
									</li>
									<li className="flex items-start lg:col-span-1">
										<div className="flex-shrink-0">
											<svg
										...
										<p className="ml-3 text-sm text-gray-700">Cylinder: {cylinder}</p>
									</li>
									<li className="flex items-start lg:col-span-1">
										<div className="flex-shrink-0">
											<svg
										...
										<p className="ml-3 text-sm text-gray-700">
											Mileage: {mileageByUnit} ({mileageUnit})
										</p>
									</li>
								</ul>
							</div>
